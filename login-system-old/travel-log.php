...
<body>
    ...
    <div class="overlay" id="overlay"></div>
        ...
        <div class="dashboard-container">
            ...
            <aside class="sidebar">
                ...
                <ul class="nav-menu">
                    ...
                    <li class="nav-item">
                        <a href="travel-log.php" class="nav-link active">
        ...
        <main class="main-content">
            ...
            <!-- Travel Logs Container -->
            <div class="travel-logs-container">
                <?php if (empty($travel_logs)): ?>
                <?php else: ?>
                    <?php foreach ($travel_logs as $log): ?>
                        <div class="travel-log-card">
                            <div class="log-header">
                                <span>Posted by <?= htmlspecialchars($log['username']) ?></span>
                                <span><?= date('M j, Y', strtotime($log['created_at'])) ?></span>
                            </div>
                            <?php if ($log['image_path']): ?>
                                <img src="<?= htmlspecialchars($log['image_path']) ?>" alt="<?= htmlspecialchars($log['title']) ?>" class="log-image">
                            <?php endif; ?>
                            <h3 class="log-title"><?= htmlspecialchars($log['title']) ?></h3>
                            <div class="log-content"><?= nl2br(htmlspecialchars($log['content'])) ?></div>
                        </div>
                    <?php endforeach; ?>
                <?php endif; ?>
            </div>
